...
/***/ "./src/components/front-yt/_front-yt.js":
/*!**********************************************!*\
  !*** ./src/components/front-yt/_front-yt.js ***!
  \**********************************************/
/***/ (() => {
...
8. Создадим элемент asideLi меню aside с 20 видео

9. По клику на элемент asideLi
9.1 добавим ему class="active"
9.2 выведем список всех видео
9.3 добавим тему в заголовок h2

10. Добавляем элемент asideLi в массив parentDiv для элементов меню aside
*/
...
/***/ "./src/components/front-yt/js/create-channels.js":
/*!*******************************************************!*\
  !*** ./src/components/front-yt/js/create-channels.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
/*Создадим класс от которого будут наследоваться объекты каналов*/
var Channel = /*#__PURE__*/_createClass(function Channel(id, theme, title, author, city, country, link, site, dateFirstVideo, dateLastVideo) {
  var amountVideos = arguments.length > 10 && arguments[10] !== undefined ? arguments[10] : 0;
  ...
  this.link = link;
  this.site = site;
  this.dateFirstVideo = dateFirstVideo;
  this.dateLastVideo = dateLastVideo;
  this.amountVideos = amountVideos;
});
/*****************
Функция createChannels создает канал для каждого элемента из массива channels
*****************/
function createChannels(channels) {
  var dataChannels = [];
  for (var i = 0; i < channels.length; i++) {
    dataChannels[i] = new Channel(channels[i].id, channels[i].theme, channels[i].title, channels[i].author, channels[i].city, channels[i].country, channels[i].link, channels[i].site, channels[i].dateFirstVideo, channels[i].dateLastVideo, channels[i].amountVideos);
  }
  ;
  return dataChannels;
}
...
/***/ "./src/components/front-yt/js/create-nav.js":
/*!**************************************************!*\
  !*** ./src/components/front-yt/js/create-nav.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/*****************
Функция createNav возвращает элементы nav меню
*****************/
/*
Алгоритм работы
1. Функция createNav принимает массив theme с темами
2. Создаем массив parentDiv для элементов меню nav
3. Для каждой темы из массива с темами создаем элемент elementLi меню nav
4. Добавляем элемент elementLi в массив parentDiv для элементов меню nav
*/
...
function createNav(menu) {
  ...
  for (var i = 0; i < menu.length; i++) {
    //3. Для каждой темы из массива с темами создаем элемент elementLi меню nav
    var elementLi = document.createElement('a');
    elementLi.href = "#";
    elementLi.innerHTML = menu[i];
...
/***/ "./src/components/front-yt/js/create-theme.js":
/*!****************************************************!*\
  !*** ./src/components/front-yt/js/create-theme.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/*****************
Функция createTheme возвращает массив тем
*****************/
/*
Алгоритм работы
1. Функция createTheme принимает массив channels с каналами
2. Создаем массив themes с темами из массива с каналами
3. Создаем массив menu без повторяющихся тем
4. Возвращаем массив menu
*/

//1. Функция createTheme принимает массив channels с каналами
function createTheme(channels) {
  //2. Создаем массив themes с темами из массива с каналами
  var themes = channels.map(function (el) {
    return el.theme;
  });

  //3. Создаем массив menu без повторяющихся тем
  var set = new Set(themes);
  var menu = Array.from(set);
  return menu;
}

/***/ }),

/***/ "./src/components/front-yt/js/data-yt/data-yt-cz.js":
/*!**********************************************************!*\
  !*** ./src/components/front-yt/js/data-yt/data-yt-cz.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "dataYoutubeCzech": () => (/* binding */ dataYoutubeCzech)
/* harmony export */ });
var dataYoutubeCzech = [{
  "id": 1,
  "theme": "frontend cze",
...
/***/ "./src/components/front-yt/js/data-yt/data-yt-en.js":
/*!**********************************************************!*\
  !*** ./src/components/front-yt/js/data-yt/data-yt-en.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "dataYoutubeEng": () => (/* binding */ dataYoutubeEng)
/* harmony export */ });
var dataYoutubeEng = [{
  "id": 1,
  "theme": "frontend eng",
...
/***/ "./src/components/front-yt/js/data-yt/data-yt-py.js":
/*!**********************************************************!*\
  !*** ./src/components/front-yt/js/data-yt/data-yt-py.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "dataYoutubePython": () => (/* binding */ dataYoutubePython)
/* harmony export */ });
var dataYoutubePython = [{
  "id": 1,
  "theme": "python",
...
/***/ "./src/components/front-yt/js/data-yt/data-yt-sr.js":
/*!**********************************************************!*\
  !*** ./src/components/front-yt/js/data-yt/data-yt-sr.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "dataYoutubeSrb": () => (/* binding */ dataYoutubeSrb)
/* harmony export */ });
var dataYoutubeSrb = [{
  "id": 1,
  "theme": "frontend srb",
...
/***/ "./src/components/front-yt/js/data-yt/data-yt.js":
/*!*******************************************************!*\
  !*** ./src/components/front-yt/js/data-yt/data-yt.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "dataYoutube": () => (/* binding */ dataYoutube)
/* harmony export */ });
var dataYoutube = [{
  "id": 1,
  "theme": "frontend",
  ...
  "id": 87,
  "theme": "frontend",
  "title": "Elbrus Coding Bootcamp",
  "author": "",
  "city": "",
  "country": "Россия",
  "link": "https://www.youtube.com/@ElbrusCodingBootcamp/videos",
  "site": "https://elbrusboot.camp/",
  "dateFirstVideo": "2019.04.25",
  ...
  "id": 155,
  "theme": "frontend",
  "title": "IT Курсы от AROKEN",
  "author": "",
  "city": "",
  "country": "Россия",
  "link": "https://www.youtube.com/@learnaroken/videos",
  "site": "",
  ...
  "id": 222,
  "theme": "frontend",
  "title": "Школа программирования dpv.school",
  "author": "",
  "city": "",
  "country": "Россия",
  ...
  "id": 276,
  "theme": "frontend",
  "title": "Имрон Фронтенд",
  "author": "",
  "city": "",
  "country": "США",
  "link": "https://www.youtube.com/@imronfrontend/videos",
  "site": "",
  ...
  "id": 315,
  "theme": "frontend",
  "title": "Валерий Стрелец",
  "author": "Валерий Стрелец",
  "city": "",
  "country": "Украина",
  "link": "https://www.youtube.com/@ValeryStrelets/videos",
  "site": "",
  "dateFirstVideo": "2020.11.22",
  "dateLastVideo": "2021.04.29",
  "amountVideos": 8
  ...
  "id": 333,
  "theme": "frontend",
  "title": "JavaScript 2022 С нуля до профи",
  "author": "",
  "city": "",
  "country": "Украина",
...
/***/ "./src/components/front-yt/js/front-yt.js":
/*!************************************************!*\
  !*** ./src/components/front-yt/js/front-yt.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _front_yt__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../_front-yt */ "./src/components/front-yt/_front-yt.js");
/* harmony import */ var _front_yt__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_front_yt__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _create_channels_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./create-channels.js */ "./src/components/front-yt/js/create-channels.js");
/* harmony import */ var _sort_channels_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sort-channels.js */ "./src/components/front-yt/js/sort-channels.js");
/* harmony import */ var _create_theme_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./create-theme.js */ "./src/components/front-yt/js/create-theme.js");
/* harmony import */ var _create_nav_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./create-nav.js */ "./src/components/front-yt/js/create-nav.js");
/* harmony import */ var _create_aside_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./create-aside.js */ "./src/components/front-yt/js/create-aside.js");
/* harmony import */ var _data_yt_data_yt_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./data-yt/data-yt.js */ "./src/components/front-yt/js/data-yt/data-yt.js");
/* harmony import */ var _data_yt_data_yt_en_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./data-yt/data-yt-en.js */ "./src/components/front-yt/js/data-yt/data-yt-en.js");
/* harmony import */ var _data_yt_data_yt_sr_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./data-yt/data-yt-sr.js */ "./src/components/front-yt/js/data-yt/data-yt-sr.js");
/* harmony import */ var _data_yt_data_yt_cz_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./data-yt/data-yt-cz.js */ "./src/components/front-yt/js/data-yt/data-yt-cz.js");
/* harmony import */ var _data_yt_data_yt_py_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./data-yt/data-yt-py.js */ "./src/components/front-yt/js/data-yt/data-yt-py.js");
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
function _iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
...
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }
/****************
Скрипт из файла youtube.js
*******************/
/*
Алгоритм работы
1. Проверяем что страница имеет id="front-yt"
2. Создаем массив данных dataArray из импортированных массивов
3. Создаем массив каналов allChannels из массива данных dataArray
4. Создаем массив channels со списком каналов из массива allChannels
5. Создаем массив themes с темами youtube каналов
6. Для каждой темы создадим элемент nav меню
7. Добавим на страницу элементы навигации mainNav
8. Создадим массив для массивов с элементами меню aside
9. Для каждой темы создадим массив элементов aside меню
10. По клику на элемент nav меню
10.1 добавим ему class="active"
10.2 показываем нужный aside
10.3 Создадим и вызовем событие click на первом aside эелементе
11. Создадим и вызовем событие click на первом nav эелементе
*/
...
var currentPage = document.querySelector('#front-yt');
...
if (currentPage) {
  (function () {
    ...
    //2. Создаем массив данных dataArray из импортированных массивов
    var dataArray = [_data_yt_data_yt_js__WEBPACK_IMPORTED_MODULE_6__.dataYoutube, _data_yt_data_yt_en_js__WEBPACK_IMPORTED_MODULE_7__.dataYoutubeEng, _data_yt_data_yt_sr_js__WEBPACK_IMPORTED_MODULE_8__.dataYoutubeSrb, _data_yt_data_yt_cz_js__WEBPACK_IMPORTED_MODULE_9__.dataYoutubeCzech, _data_yt_data_yt_py_js__WEBPACK_IMPORTED_MODULE_10__.dataYoutubePython];

    //3. Создаем массив каналов allChannels из массива данных dataArray
    var allChannels = dataArray.map(function (el) {
      return (0,_sort_channels_js__WEBPACK_IMPORTED_MODULE_2__.sortChannels)((0,_create_channels_js__WEBPACK_IMPORTED_MODULE_1__.createChannels)(el));
    });

    //4. Создаем массив channels со списком каналов из массива allChannels
    var channels = (_ref = []).concat.apply(_ref, _toConsumableArray(allChannels));

    //5. Создаем массив themes с темами youtube каналов
    var themes = (0,_create_theme_js__WEBPACK_IMPORTED_MODULE_3__.createTheme)(channels);

    //6. Для каждой темы создадим элемент nav меню
    var elementNav = (0,_create_nav_js__WEBPACK_IMPORTED_MODULE_4__.createNav)(themes);

    //7. Добавим на страницу элементы навигации mainNav
    mainNav.append.apply(mainNav, _toConsumableArray(elementNav));

    //8. Создадим массив для массивов с элементами меню aside
    var elementAside = [];
    var _loop = function _loop(i) {
      //9. Для каждой темы создадим массив элементов aside меню
      elementAside[i] = (0,_create_aside_js__WEBPACK_IMPORTED_MODULE_5__.createAside)(allChannels[i]);

      //10. По клику на элемент nav меню
      elementNav[i].addEventListener('click', function (e) {
        e.preventDefault();

        //10.1 добавим ему class="active"
        classActive(elementNav, elementNav[i]);

        //10.2 показываем нужный aside
        aside.innerHTML = '';
        aside.append.apply(aside, _toConsumableArray(elementAside[i]));

        //10.3 Создадим и вызовем событие click на первом aside эелементе
        var eventClick = new Event('click');
        elementAside[i][1].dispatchEvent(eventClick);
      });
    };
    ...
    //11. Создадим и вызовем событие click на первом nav эелементе
    var eventClick = new Event('click');
    elementNav[0].dispatchEvent(eventClick);
  })();
}

/***/ }),

/***/ "./src/components/front-yt/js/sort-channels.js":
/*!*****************************************************!*\
  !*** ./src/components/front-yt/js/sort-channels.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "sortChannels": () => (/* binding */ sortChannels)
/* harmony export */ });
/*****************
Функция sortChannels фильтрует каналы с названиями, сортирует по числу видео и по названию
*****************/
function sortChannels(channels) {
  ...
  channels.sort(function (a, b) {
    if (b.amountVideos === a.amountVideos) {
      //Если число видео одинаковое то сортируем каналы по названию
      return a.title.localeCompare(b.title, 'en');
    } else {
      //Иначе соритуем по числу видео
      return b.amountVideos - a.amountVideos;
    }
  });
  return channels;
}
...
/* harmony import */ var _components_front_yt_js_front_yt__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/front-yt/js/front-yt */ "./src/components/front-yt/js/front-yt.js");
